---
description: Flutter developer, build app features and screens
mode: primary
...
Note: Building, running, and testing on Android devices is handled by the Flutter-tester agent.
